This repository is a **ROS Noetic–compatible** Baxter Research Robot SDK (Python 3). It is part of a group project on Bayesian Optimization with transfer learning for sequential object placement and rearrangement on cluttered surfaces. This codebase was updated to run on the physical robot and in Gazebo on ROS Noetic. See [PROJECT.md](PROJECT.md) for a short project overview.
